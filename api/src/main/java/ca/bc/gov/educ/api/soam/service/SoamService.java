...
public class SoamService {
  ...
  @Autowired
  public SoamService(final ApplicationProperties props, final CodeTableUtils codeTableUtils, final RestUtils restUtils) {
    this.props = props;
  ...
  public void performLogin(String identifierType, String identifierValue, String userID, ServicesCardEntity servicesCard) {
    ...
    response = getOrCreateDigitalId(identifierType, identifierValue, userID, servicesCard, restTemplate, headers);
    if (response == null) return;
		updateDigitalID(servicesCard, restTemplate, headers, response);
	}
	...
	private ResponseEntity<DigitalIDEntity> getOrCreateDigitalId(String identifierType, String identifierValue, String userID, ServicesCardEntity servicesCard, RestTemplate restTemplate, HttpHeaders headers) {
    ResponseEntity<DigitalIDEntity> response;
    try {
